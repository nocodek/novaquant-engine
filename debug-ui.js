...
(async () => {
  ...
  if (hasRange) {
     ...
     const display = await page.evaluate(() => {
        ...
        return 'Calendar is: ' + cal.className + ' | display: ' + getComputedStyle(cal).display + ' | top: ' + cal.style.top + ' | opacity: ' + getComputedStyle(cal).opacity + ' | visibility: ' + getComputedStyle(cal).visibility;
     });
     console.log(display);
  }
